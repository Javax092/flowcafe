...
-- CreateEnum
CREATE TYPE "CashMovementType" AS ENUM ('OPENING', 'CASH_IN', 'CASH_OUT', 'CLOSING');
...
-- CreateIndex
CREATE INDEX "CashSession_dailyDate_idx" ON "CashSession"("dailyDate");
...
-- CreateIndex
CREATE INDEX "Sale_dailyDate_idx" ON "Sale"("dailyDate");
